...
async def main():
    ...
    await app.run_polling()  # O próprio `run_polling()` já gerencia o loop de eventos

# === EXECUTA O BOT SEM USAR asyncio.run ===
if __name__ == '__main__':
    import asyncio
    # O método run_polling() já lida com o loop de eventos internamente
    asyncio.run(main())  # Agora podemos usar asyncio.run sem erro
