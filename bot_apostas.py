...
if __name__ == '__main__':
    import asyncio
    # Remove o uso do asyncio.run e chama diretamente o polling
    asyncio.run(main())  # Aqui chamamos o asyncio.run apenas para iniciar o código de forma apropriada
